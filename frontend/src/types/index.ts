...
export type LeaveApplication = { id: string; applicationNumber: string; employeeName: string; leaveTypeCode: string; startDate: string; endDate: string; totalDays: number; reason: string; status: string; appliedAt: string; managerRemarks?: string; hrRemarks?: string };
export type ExpenseItem = { id: string; category: string; description: string; amount: number; expenseDate: string; receiptUrl?: string };
export type ExpenseClaim = { id: string; claimNumber: string; employeeName: string; title: string; totalAmount: number; currency: string; status: string; submittedAt?: string; items: ExpenseItem[] };
