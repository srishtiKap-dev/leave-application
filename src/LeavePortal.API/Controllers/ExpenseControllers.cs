...
public sealed class ExpenseApprovalsController(IPortalService portal) : BaseApiController
{
    ...
    [HttpPost("{id:guid}/reject")] public ActionResult<ApiResponse<object>> Reject(Guid id, [FromBody] ApprovalRequest request) => OkResponse<object>(new { id, request.Remarks }, "Expense rejected.");
}
...
public sealed class FinanceController(IPortalService portal) : BaseApiController
{
    ...
    [HttpPost("expense-claims/{id:guid}/reject")] public ActionResult<ApiResponse<object>> Reject(Guid id, [FromBody] ApprovalRequest request) => OkResponse<object>(new { id, request.Remarks }, "Expense rejected.");
